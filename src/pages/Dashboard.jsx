  ...
  return (
    <div className="p-8">
      ...
      <div>
        ...
        <div>
          {events.map((event) => (
            <div className="p-2 border-l-8" key={event.id}>
              <h1 className="font-bold">Event Name: {event.EventName}</h1>
              <h1>Event Date: {event.EventDate}</h1>
              <h1>Event Time: {event.EventTime}</h1>
              ...
              <div className="p-2">
                <button className="bg-eventManagement-black p-2 text-white font-bold">
                  Edit
                </button>
                <button
                  className="bg-red-800 p-2 text-white font-bold ml-2"
                >
                  Delete
                </button>
              </div>
